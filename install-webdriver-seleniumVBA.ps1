...
$form.Text = "SeleniumVBA WebDriver Installer v$appVersion"
...
function Install-WebDriver {
    ...
    # Check SeleniumVBA installation path
    ...
    if (Test-Path $LocalPath) {
        ...
        Write-Log "SeleniumVBA found in user local path."
        Write-Log "Installation path: $DriverPath"
    }
    elseif (Test-Path $ProgramPath) {
        $DriverPath = $ProgramPath
        Write-Log "SeleniumVBA found in Program Files path."
        Write-Log "Installation path: $DriverPath"
    }
    else {
        Write-Log "SeleniumVBA is not installed!"
        Write-Log "Please install SeleniumVBA in one of the following paths:"
